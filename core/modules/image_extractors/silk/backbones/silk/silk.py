...
from ..abstract.shared_backbone_multiple_heads import (
    SharedBackboneMultipleHeads,
)
from ..loftr.resnet_fpn import ResNetFPN_8_2
from ..superpoint.magicpoint import (
    Backbone as VGGBackbone,
    DetectorHead as VGGDetectorHead,
    MagicPoint,
)
from ..superpoint.superpoint import (
    DescriptorHead as VGGDescriptorHead,
    SuperPoint,
)
from ...flow import AutoForward, Flow
from ...models.superpoint_utils import get_dense_positions
